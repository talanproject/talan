...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // talan
        hashUTXORoot.SetNull(); // talan
    ...
    virtual bool IsProofOfStake() const //talan
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //talan
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //talan
    {
