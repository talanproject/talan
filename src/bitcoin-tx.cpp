...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " talan-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  talan-tx [options] <hex-tx> [commands]  Update hex-encoded talan transaction\n" +
            "or:     talan-tx [options] -create [commands]   Create hex-encoded talan transaction\n" +
            "\n";
