    ...
    gui(nullptr)
{
    ...
    QPushButton *exportButton = new TalanPushButton(tr("&Export"), this);
    ...
    TLRCTokenPage = new TLRCToken(platformStyle);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    TLRCTokenPage->setClientModel(_clientModel);
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    TLRCTokenPage->setModel(_walletModel);
...
{
    setCurrentWidget(TLRCTokenPage);
}
