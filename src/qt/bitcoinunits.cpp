...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("TALAN");
    case mBTC: return QString("mTALAN");
    case uBTC: return QString::fromUtf8("μTALAN (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Talans");
    case mBTC: return QString("Milli-Talans (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Talans (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
