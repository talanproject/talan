#ifndef TALANVERSIONCHECKER_H
#define TALANVERSIONCHECKER_H

#include <QObject>

#define TALAN_RELEASES "https://github.com/talanproject/talan/releases"
...
class TalanVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit TalanVersionChecker(QObject *parent = 0);
    ~TalanVersionChecker();
