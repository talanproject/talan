...
const char * const BITCOIN_CONF_FILENAME = "talan.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Talan
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Talan
    // Mac: ~/Library/Application Support/Talan
    // Unix: ~/.talan
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Talan";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Talan";
#else
    // Unix
    return pathRet / ".talan";
#endif
#endif
}
