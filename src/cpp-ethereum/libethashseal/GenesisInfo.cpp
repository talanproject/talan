...
#include "genesis/talanMainNetwork.cpp"
...
#include "genesis/test/talanTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::talanMainNetwork: return c_genesisInfoTalanMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::talanTestNetwork: return c_genesisInfoTalanTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::talanMainNetwork: return c_genesisStateRootTalanMainNetwork;
    case Network::talanTestNetwork: return c_genesisStateRootTalanTestNetwork;
