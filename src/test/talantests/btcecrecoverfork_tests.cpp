...
//    initState();
    ...
    std::vector<TalanTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createTalanTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createTalanTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createTalanTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createTalanTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
