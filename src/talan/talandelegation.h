#ifndef TALANDELEGATION_H
#define TALANDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The ITalanStaker class Delegation filter
 */
...
/**
 * @brief The TalanDelegation class Communicate with the talan delegation contract
 */
class TalanDelegation {
    
public:
    /**
     * @brief TalanDelegation Constructor
     */
    TalanDelegation();

    /**
     * @brief ~TalanDelegation Destructor
     */
    virtual ~TalanDelegation();
...
private:
    TalanDelegation(const TalanDelegation&);
    TalanDelegation& operator=(const TalanDelegation&);
    TalanDelegationPriv* priv;
};
#endif
